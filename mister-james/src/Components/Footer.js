...
function Footer() {
  ...
  return (
    ...
    <div className='w-[80%] opacity-[80%] font-bold gap-8 border-t-2 border-white mt-10 pb-8 mx-auto border-b-2 lg:flex lg:flex-row lg:justify-between lg:items-center lg:pr-7'>
        <div className='flex flex-col items-center gap-8 mt-6 lg:flex-row'>
            <div className='flex gap-3 items-center coordo'>
    ...
    <div className='flex flex-col items-center opacity-[80%] font-bold gap-4 mt-6 mb-2 lg:flex-row w-[80%] mx-auto lg:justify-start'>
